...
public class EntityThrow extends Entity implements IProjectile, IEntityAdditionalSpawnData{
	...
	public EntityThrow(World world, EntityLivingBase shootingEntity, float speed, ItemStack stack) {
		super(world);
        ...
        this.setLocationAndAngles(shootingEntity.posX, shootingEntity.posY + (double)shootingEntity.getEyeHeight(), shootingEntity.posZ, shootingEntity.rotationYaw, shootingEntity.rotationPitch);
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.capabilities.isCreativeMode && !par1EntityPlayer.inventory.addItemStackToInventory(stack))
            {
                var2 = false;
            }
