...
public class GlassTable extends Table{
	...
	public ArrayList<CubeObject> getCubes(ItemStack stack, IBlockAccess world,
		...
		if(!nX)
			cubes.add(new CubeObject(0, 0.8, 0.5-size/2, 0.5-size/2, 0.9, 0.5+size/2, Blocks.planks.getIcon(0, plank)));
		if(!pX)
			cubes.add(new CubeObject(0.5+size/2, 0.8, 0.5-size/2, 1, 0.9, 0.5+size/2, Blocks.planks.getIcon(0, plank)));
		if(!pZ)
			cubes.add(new CubeObject(0.5-size/2, 0.8, 0.5+size/2, 0.5+size/2, 0.9, 1, Blocks.planks.getIcon(0, plank)));
		if(!nZ)
			cubes.add(new CubeObject(0.5-size/2, 0.8, 0, 0.5+size/2, 0.9, 0.5-size/2, Blocks.planks.getIcon(0, plank)));
		
		if(!nX || !nZ)
			cubes.add(new CubeObject(0, 0.8, 0, 0.5-size/2, 0.9, 0.5-size/2, Blocks.planks.getIcon(0, plank)));
		if(!pX || !nZ)
			cubes.add(new CubeObject(0.5+size/2, 0.8, 0, 1, 0.9, 0.5-size/2, Blocks.planks.getIcon(0, plank)));
		if(!nX || !pZ)
			cubes.add(new CubeObject(0, 0.8, 0.5+size/2,  0.5-size/2, 0.9, 1, Blocks.planks.getIcon(0, plank)));
		if(!pX || !pZ)
			cubes.add(new CubeObject(0.5+size/2, 0.8, 0.5+size/2, 1, 0.9, 1, Blocks.planks.getIcon(0, plank)));
		...
		cubes.add(new CubeObject(minX, 0.8, minZ, maxX, 0.9, maxZ, Blocks.glass));
